...
ax.yaxis.set_ticks([1e-12,1e-8,1e-4,1e0])
...
secay.yaxis.set_ticks([1e-12,1e-8,1e-4,1e0])
secay.tick_params(direction='inout',which='major', length=11)


ax.text(1.4,0.5,r'(a)', fontsize='27')

plt.savefig('tdse_A05_T2.pdf', format='pdf', bbox_inches='tight', facecolor='none')
plt.show();
